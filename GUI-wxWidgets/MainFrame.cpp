...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title)
{
	...
	wxButton* button = new wxButton(panel, wxID_ANY, "Button", wxPoint(300, 75), wxSize(200, 50));
	wxSlider* slider = new wxSlider(panel, wxID_ANY, 50, 0, 100, wxPoint(300, 200), wxSize(200, -1), wxSL_VALUE_LABEL);
